...
<footer id="footer">
      ...
      <div className="row">
        <div className="col-lg-3 col-md-6">
          <div className="footer-info">
            <h3>Rajaram Solvex<span>.</span></h3>
            <p>
              ABC Rajaramnagar <br />
              Sangli 415414, MH<br /><br />
              <strong>Phone:</strong> 0000000000<br />
              <strong>Email:</strong> asdf@example.com<br />
            </p>
  ...
  <div className="container">
    <div className="copyright">
      © Copyright <strong><span>Rajaram Solvex</span></strong>. All Rights Reserved
    </div>
